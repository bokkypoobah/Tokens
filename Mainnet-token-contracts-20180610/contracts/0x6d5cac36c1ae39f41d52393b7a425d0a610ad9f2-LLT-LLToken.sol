...
contract LockableToken is StandardToken, ReentrancyGuard {
    ...
    // ç»Â™ _to è½¬ç§» _value ä¸ªéÂ”Âå®ÂšåÂˆ° _releaseTime çÂšÂ„ token
    ...
    // æÂŸ¥ address çÂšÂ„éÂ”Âå®Âšä½Â™é¢Â
    ...
    // è§£éÂ”ÂæÂ‰Â€æÂœÂ‰å·²åÂˆ°éÂ”Âå®ÂšæÂ—¶éÂ—´çÂšÂ„ token
...
contract ReleaseableToken is Operational, LockableToken {
    ...
    bool secondYearUpdate = false; // Limit æÂ›´æÂ–°åÂˆ°ç¬¬äºÂŒå¹´
    uint256 public releasedSupply; // å·²éÂ‡ÂŠæÂ”¾çÂšÂ„æÂ•°éÂ‡Â
    uint256 public createTime; // åÂÂˆçº¦åÂˆÂ›å»ºæÂ—¶éÂ—´
    uint256 standardDecimals = 100000000; // çÂ”±äºÂŽæÂœÂ‰8ä½Âå°ÂæÂ•°ï¼ÂŒä¼ è¿Â›æÂ¥çÂšÂ„åÂÂ‚æÂ•°éÂƒ½æÂ˜¯ä¸Âå¸¦åÂÂŽéÂ¢çÂšÂ„å°ÂæÂ•°ï¼ÂŒè¦ÂæÂœÂ‰ä¹Â˜100000000çÂšÂ„æÂ“Âä½ÂœæÂ‰ÂèÂƒ½ä¿Âè¯ÂæÂ•°éÂ‡Âçº§ä¸Â€èÂ‡´
    uint256 public totalSupply = standardDecimals.mul(1000000000); // æÂ€»éÂ‡Â10äº¿
    uint256 public limitSupplyPerYear = standardDecimals.mul(60000000); // æ¯Âå¹´éÂ‡ÂŠæÂ”¾çÂšÂ„LLTçÂšÂ„éÂ™Âé¢Âï¼ÂŒç¬¬ä¸Â€å¹´6000ä¸Â‡
    uint256 public dailyLimit = standardDecimals.mul(1000000); // æ¯Âå¤©éÂ‡ÂŠæÂ”¾çÂšÂ„éÂ™Âé¢Â
    ...
    struct FrozenRecord {
        uint256 amount; // åÂ†»ç»Â“çÂšÂ„æÂ•°éÂ‡Â
        uint256 unfreezeTime; // è§£åÂ†»çÂšÂ„æÂ—¶éÂ—´
    }
    ...
    // åÂœ¨ timestamp æÂ—¶éÂ—´çÂ‚¹éÂ‡ÂŠæÂ”¾ releaseAmount çÂšÂ„ token
    ...
    // åÂˆ¤æÂ–­ timestamp è¿Â™ä¸Â€å¤©æÂœÂ‰æ²¡æÂœÂ‰å·²ç»ÂéÂ‡ÂŠæÂ”¾çÂšÂ„è®°å½Â•
    ...
    // æÂ›´æÂ–°æ¯Âå¹´éÂ‡ÂŠæÂ”¾tokençÂšÂ„éÂ™ÂåÂˆ¶æÂ•°éÂ‡Â
    ...
    // è§£åÂ†» releaseSupply ä¸­éÂ‡ÂŠæÂ”¾çÂšÂ„ token
    ...
    // è®¾ç½®æ¯Âå¤©éÂ‡ÂŠæÂ”¾ token çÂšÂ„éÂ™Âé¢Â
